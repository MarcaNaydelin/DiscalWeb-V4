...
const AlertNotification = ({ message, type = "success", onClose }) => {
  ...
  return (
    <div className={`alert-container ${config.className}`}>
      <div className="alert-content">
        <div className="alert-icon-wrapper">
          {config.icon}
        </div>
        <div className="alert-text">
          <span className="alert-title">{config.title}</span>
        ...
        >
          <svg className="alert-close-icon" viewBox="0 0 20 20" fill="currentColor">
...
export const alertMessages = {
  // Registro
  registerSuccess: "¡Cuenta creada exitosamente! Ya puedes iniciar sesión.",
  registerEmailExists: "Este correo electrónico ya está registrado.",
  registerUserExists: "Este nombre de usuario ya existe.",
